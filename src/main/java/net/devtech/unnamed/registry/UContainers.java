...
public interface UContainers {
	...
	ScreenHandlerType<StirlingEngineGui> STIRLING_ENGINE = register("stirling_engine", StirlingEngineGui::new, StirlingEngineGui.Screen::new);
	ScreenHandlerType<GrinderGui> GRINDER_GUI = register("grinder", GrinderGui::new, GrinderGui.Screen::new);
	// @formatter:off
